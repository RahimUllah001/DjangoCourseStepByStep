...
class MyView(View):
    ...
    def get(self,request):
        ...
        return HttpResponse(self.name)      #returning a variable but if i am passing name from url so here should proper ttribute s above if not present then it eill give eeror

# making chil d class of above
